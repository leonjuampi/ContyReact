...
// import { useTheme } from '../../contexts/ThemeContext'; // <--- ELIMINADO
...
export default function Reports() {
  // const [activeItem, setActiveItem] = useState('reports'); // <--- ELIMINADO
  // const { isDarkMode } = useTheme(); // <--- ELIMINADO
  ...
  // const handleItemClick = (itemId: string) => { // <--- ELIMINADO
  ...
  // 4. JSX modificado: Se quita el div wrapper, Sidebar y TopBar y se usa <>.
  return (
    <>
      <main className="p-6">
        {/* Header de Filtros - Sticky */}
        {/* El 'sticky top-0' se ajustará al 'TopBar' del layout principal */}
