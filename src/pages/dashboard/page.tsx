// 1. Quitamos los imports de layout (Sidebar, TopBar, useState, useNavigate, useTheme)
...
export default function Dashboard() {
  // 2. Quitamos todos los 'useState' y 'handlers' que eran para el layout
  // (activeItem, handleItemClick, handleNewSale, isDarkMode, etc.)

  // 3. Devolvemos solo el contenido de la página,
  //    incluyendo el <main className="p-6"> que le da el padding
  return (
    <main className="p-6">
